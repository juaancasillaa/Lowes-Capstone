...
// import whatis from "../images/whatis2.png";
...
//                 in need. Spark makes it easy to find the ideal opportunity based on your interests and availability.</p>
//             </div>
//             <div className="col-md-3 col-md-3s col-md-3ss">
//               <img className="whatis " src={whatis} alt="First-img"/>
//             </div>
//           </div>
//         </div>
//       </section>

//       <section className="stats-sections stats-section text-center">
//         <div className="container">
//           <h3 id="unique" className="about-h3">Our Guiding Principles</h3>
//           <div className="row">
